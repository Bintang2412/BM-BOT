...
${desc}`)
        ...
        case '#pinterest':
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#pinterest [query]*\nContoh : *#pinterest BM-BOT*', id)
            ...
            binn.sendImage(from, base64, 'ptrs.jpg', `*Pinterest*\n\n*Hasil Pencarian : ${ptrsq}*`)
            break
        case '#nhview':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#nhview [212121]*\nContoh : *#nhview 321421*', id)
            ...
            for (let i = 0; i < nhsh2.length; i++) {
                await binn.sendImage(from, nhsh2[i].data, 'thumbserc.jpg', '', id)
                }
            break
        case '#loli':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            binn.sendFileFromUrl(from, loli.data.result, 'loli.jpeg', '*LOLI*', id)
            break
        case '#shota':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFile(from, img, "shota.jpg", `*SHOTA*`, id)
                    }) 
                .catch(
                    (error) => {
                        console.log(error);
        ...
        case '#waifu':
            ...
            binn.sendFileFromUrl(from, waifu.data.image, 'Waifu.jpg', `➸ Name : ${waifu.data.name}\n➸ Description : ${waifu.data.desc}\n\n➸ Source : ${waifu.data.source}`, id)
            break
        case '#husbu':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, rindKiy.image, 'Husbu.jpg', rindKiy.teks, id)
            break
        case '#randomnekonime':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, nekon.result, `Nekonime${ext}`, 'Nekonime!', id)
            break
        case '#randomtrapnime':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            binn.sendImage(from, trapn.result, `trapnime${ext}`, 'Trapnime!', id)
            break
        case '#randomhentai':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isNsfw) return binn.reply(from, 'command/Perintah NSFW belum di aktifkan di group ini!', id)
            ...
            binn.sendImage(from, henta.result, `RandomHentai${ext}`, 'Random Hentai!', id)
            break
        case '#randomnsfwneko':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isNsfw) return binn.reply(from, 'command/Perintah NSFW belum di aktifkan di group ini!', id)
            ...
            binn.sendImage(from, nsfwn.result, `NsfwNeko${ext}`, 'NsfwNeko!', id)
            break
        case '#randomanime':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, ranime.url, `RandomAnime${ext}`, 'Random Anime!', id)
            break
        case '#nhder':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isNsfw) return binn.reply(from, 'command/Perintah NSFW belum di aktifkan di group ini!', id)
            ...
            if (args.length >=2){
                ...
                binn.sendText(from, caption)
            } else {
                binn.sendText(from, 'Maaf tolong masukan code nuclear')
            }
            break
        /*case '#wallanime' :
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            binn.sendFileFromUrl(from, walnimek, 'Nimek.jpg', '', id)
            break*/
        case '#quotesnime':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            skya_ = skya.data
            binn.reply(from, `➸ *Quotes* : ${skya_.quote}\n➸ *Character* : ${skya_.character}\n➸ *Anime* : ${skya_.anime}`, id)
            break
        case '#meme':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, `${url}`, 'meme.jpg', `${title}`)
            break
        /* case '#nekopoi':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isNsfw) return binn.reply(from, 'command/Perintah NSFW belum di aktifkan di group ini!', id)
                        ...
                        if(args[1]){
                            if(args[1] === 'anime'){
                                ...
                                axios.get('https://animechanapi.xyz/api/quotes?anime='+anime).then(({ data }) => {
                                    ...
                                    binn.sendText(from, `"${quote}"\n\nCharacter : ${char}\nAnime : ${anime}`)
                                }).catch(err => {
                                    binn.sendText('Quote Char/Anime tidak ditemukan!')
                                })
                            }else{
        ...
        case '#malanime':
           ...
           `https://api.jikan.moe/v3/search/anime?q=${keyword}`
            ...
            if (!parsed) {
              await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, Anime tidak ditemukan', id)
              return null
              }
...
🌐️ *URL*: ${url}`
            ...
            const base64 = `data:image/jpg;base64,${image.toString("base64")}`
            binn.sendImage(from, base64, title, content)
           } catch (err) {
             console.error(err.message)
             await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, Anime tidak ditemukan')
           }
          break
        case '#malcharacter':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
...
🌐️ *URL*: ${url}`
            ...
            const image = await bent("buffer")(image_url)
            const base64 = `data:image/jpg;base64,${image.toString("base64")}`
            binn.sendImage(from, base64, name, contentt)
           } catch (err) {
             console.error(err.message)
             await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, Anime tidak ditemukan')
           }
        ...
        case '#infogempa':
            ...
            binn.sendFileFromUrl(from, map, 'shakemap.jpg', hasil, id)
            break
        case '#ssweb':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#ssweb [linkWeb]*\nContoh : *#ssweb https://neonime.vip*', id)
            const ssw = await axios.get('https://mhankbarbar.herokuapp.com/api/url2image?url=' + body.slice(7) + '&apiKey=' + barbarkey)
            const ssww = ssw.data
            if (ssww.error) return binn.reply(from, ssww.error, id)
            const ssw2 = `Filesize: ${ssww.filesize}`
            binn.sendFileFromUrl(from, ssww.result, 'ssweb.jpg', ssw2, id)
            break
        case '#shorturl':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
        ...
        case '#cuaca':
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#cuaca [tempat]*\nContoh : *#cuaca tangerang', id)
        ...
        case '#covid':
            ...
            const { cases, todayCases, deaths, todayDeaths, active } = response2.data
                await binn.sendText(from, '🌎️ Covid Info - ' + country + ' 🌍️\n\n✨️ Total Cases: ' + `${cases}` + '\n📆️ Today\'s Cases: ' + `${todayCases}` + '\n☣️ Total Deaths: ' + `${deaths}` + '\n☢️ Today\'s Deaths: ' + `${todayDeaths}` + '\n⛩️ Active Cases: ' + `${active}` + '.')
            break
        case '#spamcall':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            if (!isOwner, !isAdmin) return binn.reply(from, 'Perintah ini hanya untuk Owner & Admin bot', id)
            arg = body.trim().split(' ')
            console.log(...arg[1])
            var slicedArgs = Array.prototype.slice.call(arg, 1);
            console.log(slicedArgs)
            ...
            const { logs } = call2.data
                await binn.sendText(from, `Logs : ${logs}` + '.')
            break
        case '#ytmp3':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#ytmp3 [linkYt]*, untuk contoh silahkan kirim perintah *#readme*')
            let isLinks = args[1].match(/(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/)
            if (!isLinks) return binn.reply(from, mess.error.Iv, id)
            try {
                binn.reply(from, mess.wait, id)
                const resp = await axios.get('https://mhankbarbar.herokuapp.com/api/yta?url='+ args[1] +'&apiKey='+ barbarkey)
                if (resp.data.error) {
                    binn.reply(from, resp.data.error, id)
                } else {
                    ...
                    binn.sendFileFromUrl(from, thumb, 'thumb.jpg', `➸ *Judul* : ${title}\n➸ *Filesize* : ${filesize}\n\nSilahkan tunggu sebentar proses pengiriman file membutuhkan waktu beberapa menit.`, id)
                    await binn.sendFileFromUrl(from, result, `${title}.mp3`, '', id).catch(() => tobz.reply(from, mess.error.Yt3, id))
                }
            } catch (err) {
                binn.sendText(ownerNumber, 'Error ytmp3 : '+ err)
                binn.reply(from, mess.error.Yt3, id)
            }
            break
        case '#google':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            if(googleQuery == undefined || googleQuery == ' ') return binn.reply(from, `*Hasil Pencarian : ${googleQuery}* tidak ditemukan`, id)
            google({ 'query': googleQuery }).then(results => {
            let vars = `_*Hasil Pencarian : ${googleQuery}*_\n`
            for (let i = 0; i < results.length; i++) {
                vars +=  `\n═════════════════\n\n*Judul* : ${results[i].title}\n\n*Deskripsi* : ${results[i].snippet}\n\n*Link* : ${results[i].link}\n\n`
            }
                binn.reply(from, vars, id);
            }).catch(e => {
                console.log(e)
                binn.sendText(ownerNumber, 'Google Error : ' + e);
            })
            break
        case '#translate':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            if(args.length >= 2){
                ...
                translatte(text, {to: codelang}).then(res => {
                    binn.sendText(from,res.text);
                    limitAdd(serial)
                }).catch(err => {
                     binn.sendText(from,`[ERROR] Teks tidak ada, atau kode bahasa ${codelang} tidak support\n~> *#bahasa* untuk melihat list kode bahasa`);
                });
            }
            break
        case '#nhentai': // SEARCH NHENTAI
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            binn.reply(from, 'PREMIUM COMMAND, HUBUNGI : wa.me/628987273758', id)
          break
        ...
        case '#ytmp4':
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#ytmp4 [linkYt]*, untuk contoh silahkan kirim perintah *#readme*')
            let isLin = args[1].match(/(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/)
            if (!isLin) return binn.reply(from, mess.error.Iv, id)
            try {
                binn.reply(from, mess.wait, id)
                const ytv = await axios.get('https://mhankbarbar.herokuapp.com/api/ytv?url='+ args[1] +'&apiKey='+ barbarkey)
                if (ytv.data.error) {
                    binn.reply(from, ytv.data.error, id)
                } else {
                    const { result, thumb, filesize, title } = await ytv.data
                    if (Number(filesize.split(' MB')[0]) > 30.00) return binn.reply(from, 'Maaf durasi video sudah melebihi batas maksimal 30 MB!', id)
                    binn.sendFileFromUrl(from, thumb, 'thumb.jpg', `➸ *Judul* : ${title}\n➸ *Filesize* : ${filesize}\n\nSilahkan tunggu sebentar proses pengiriman file membutuhkan waktu beberapa menit.`, id)
                    await binn.sendFileFromUrl(from, result, `${title}.mp4`, '', id).catch(() => binn.reply(from, mess.error.Yt4, id))
                }
            } catch (err) {
                binn.sendText(ownerNumber, 'Error ytmp4 : '+ err)
                binn.reply(from, mess.error.Yt4, id)
                console.log(err)
            }
            break
        case '#xnxx':
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#xnxx [linkXnxx]*, untuk contoh silahkan kirim perintah *#readme*')
            if (!args[1].match(isUrl) && !args[1].includes('xnxx.com')) return binn.reply(from, mess.error.Iv, id)
            try {
                binn.reply(from, mess.wait, id)
                const resq = await axios.get('https://mhankbarbar.herokuapp.com/api/xnxx?url='+ args[1] +'&apiKey='+ barbarkey)
                const resp = resq.data
                 if (resp.error) {
                    binn.reply(from, ytvv.error, id)
                } else {
                    if (Number(resp.result.size.split(' MB')[0]) > 20.00) return binn.reply(from, 'Maaf durasi video sudah melebihi batas maksimal 20 menit!', id)
                    binn.sendFileFromUrl(from, resp.result.thumb, 'thumb.jpg', `➸ *Judul* : ${resp.result.judul}\n➸ *Deskripsi* : ${resp.result.desc}\n➸ *Filesize* : ${resp.result.size}\n\nSilahkan tunggu sebentar proses pengiriman file membutuhkan waktu beberapa menit.`, id)
                    await binn.sendFileFromUrl(from, resp.result.vid, `${resp.result.title}.mp4`, '', id)}
            } catch (err) {
                console.log(err)
                await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, Video tidak ditemukan')
                binn.sendText(ownerNumber, 'Xnxx Error : ' + err)
            }
            break
            break
        case '#ramalpasangan':
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#ramalpasangan [kamu|pasangan]*\nContoh : *#ramalpasangan binn|BM-BOT*', id)
            arg = body.trim().split('|')
            if (arg.length >= 2) {
            binn.reply(from, mess.wait, id)
            const kamu = arg[0]
            ...
            binn.reply(from, rjh2, id)
            } else {
            await binn.reply(from, 'Wrong Format!', id)
            }
            break
        case '#artinama':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#artinama [query]*\nContoh : *#artinama binn*', id)
            try {
            const resp = await axios.get('https://api.vhtear.com/artinama?nama=' + body.slice(9) + '&apikey=' + vhtearkey)
            if (resp.data.error) return binn.reply(from, resp.data.error, id)
            const anm2 = `➸ Artinama : ${resp.data.result.hasil}`
            binn.reply(from, anm2, id)
            } catch (err) {
                console.error(err.message)
                await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, User tidak ditemukan')
                binn.sendText(ownerNumber, 'Artinama Error : ' + err)
           }
            break
        case '#fb':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            binn.sendFileFromUrl(from, resp.data.result, `${resp.data.titparsed}.mp4`, epbe2, id)
            } catch (err) {
             console.error(err.message)
             await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, Video tidak ditemukan')
             binn.sendText(ownerNumber, 'Facebook Error : ' + err)
           }
            break
        case '#tiktok':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#tiktok [linkTiktok]*\nContoh : *#tiktok https://vt.tiktok.com/yqyjPX/*', id)
            try {
            binn.reply(from, mess.wait, id)
...
Menunggu video...`
            ...
            binn.sendImage(from, base64, title, tpk)
            binn.sendFIle(from, video, `${title}.mp4`, '', id)
            } catch (err) {
             console.error(err.message)
             await binn.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, Video tidak ditemukan')
             binn.sendText(ownerNumber, 'Tiktok Error : ' + err)
           }
            break
        case '#wiki':
...
➸ *Wilayah:* +${region_name}`
        ...
        case '#listchannel':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            binn.reply(from, listChannel, id)
            break
        case '#jadwaltv':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#jadwalTv [channel]*', id)
            const query = body.slice(10).toLowerCase()
            const jadwal = await jadwalTv(query)
            binn.reply(from, jadwal, id)
            break
        case '#jadwaltvnow':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.reply(from, `Jam : ${jadwalNow.data.jam}\n\nJadwalTV : ${jadwalNow.data.jadwalTV}`, id)
            break
        case '#nulis':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#nulis [teks]*, contoh *#nulis aku bukan boneka*', id)
            ...
            if (ngetikk.data.error) return binn.reply(from, ngetikk.data.error, id)
            binn.sendFileFromUrl(from, ngetikk.data.result, 'nulis.jpg', '', id)
            break
                case '#inu':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, kya, 'Dog.jpeg', 'Inu')
            break
        case '#qrcode':
           if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
        if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
           ...
           await binn.sendFileFromUrl(from, `https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=${qrcodes}`, 'gambar.png', 'Process sukses!')
           break
        case '#ptl':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, pep, 'pptl.jpg', 'Follow ig : https://www.instagram.com/ptl_repost untuk mendapatkan penyegar timeline lebih banyak', message.id)
            break
        case '#neko':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, 'http://placekitten.com/'+q3+'/'+q2, 'neko.png','Neko ')
            break
        case '#pokemon':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            binn.sendFileFromUrl(from, 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/'+q7+'.png','Pokemon.png',)
            break
        case '#quote':
        case '#quotes':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            ...
            binn.reply(from, `➸ *Quotes* : ${quotez2.data.quotes}\n➸ *Author* : ${quotez2.data.author}`, id)
            break
        case '#lirik':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            await limitAdd(serial)
            if (args.length == 1) return binn.reply(from, 'Kirim perintah *#lirik [optional]*, contoh *#lirik aku bukan boneka*', id)
            const lagu = body.slice(7)
            const lirik = await liriklagu(lagu)
            binn.reply(from, lirik, id)
            break
        case '#chord':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return binn.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik #limit Untuk Mengecek Kuota Limit Kamu`, id)
            ...
            await limitAdd(serial)
            if (args.length === 1) return binn.reply(from, 'Kirim perintah *#chord [query]*, contoh *#chord aku bukan boneka*', id)
            const query__ = body.slice(7)
            const chord = await axios.get('https://mhankbarbar.herokuapp.com/api/chord?q='+ query__+'&apiKey='+ barbarkey)
            if (chord.data.error) return binn.reply(from, chord.data.error, id)
            binn.reply(from, chord.data.result, id)
            break
        case '#listdaerah':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            const listDaerah = await axios.get('https://mhankbarbar.herokuapp.com/daerah')
            binn.reply(from, listDaerah, id)
            break
        // ADMIN & OWNER
        case '#bc':
            if (!isOwner) return binn.reply(from, 'Perintah ini hanya untuk Owner BM-BOT!', id)
            let msg = body.slice(4)
            const chatz = await binn.getAllChatIds()
            for (let ids of chatz) {
                var cvk = await binn.getChatById(ids)
                if (!cvk.isReadOnly) await binn.sendText(ids, `[BM-BOT BROADCAST ]\n\n${msg}`)
            }
            binn.reply(from, 'Broadcast Success!', id)
            break
        case '#adminlist':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            let mimin = ''
            ...
            await sleep(2000)
            await binn.sendTextWithMentions(from, mimin)
            break
        case '#ownergroup':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            const Owner_ = chat.groupMetadata.owner
            await binn.sendTextWithMentions(from, `Owner Group : @${Owner_}`)
            break
        case '#otagall':
        case '#omentionall':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isOwner, !isAdmin) return binn.reply(from, 'Perintah ini hanya untuk Owner BM-BOT', id)
            const groupMek = await binn.getGroupMembers(groupId)
            ...
            heho += '╚═〘 BM-BOT 〙'
            await sleep(2000)
            await binn.sendTextWithMentions(from, heho)
            break
        case '#tagall':
        case '#mentionall':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isGroupAdmins) return binn.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin group', id)
            const groupMem = await binn.getGroupMembers(groupId)
        ...
        case '#okickall':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isOwner) return binn.reply(from, 'Perintah ini hanya untuk Admin BM-BOT', id)
            if (!isBotGroupAdmins) return binn.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
            const allMeq = await binn.getGroupMembers(groupId)
            for (let i = 0; i < allMeq.length; i++) {
                if ((adminNumber, ownerNumber).includes(allMeq[i].id)) {
                    console.log('Upss this is Admin group')
                } else {
                    await binn.removeParticipant(groupId, allMeq[i].id)
                }
            }
            binn.reply(from, 'Succes kick all member', id)
            break
        case '#kickall':
            if (!isGroupMsg) return binn.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            const isGroupOwner = sender.id === chat.groupMetadata.owner
            if (!isGroupOwner) return binn.reply(from, 'Perintah ini hanya bisa di gunakan oleh Owner group', id)
            if (!isBotGroupAdmins) return binn.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
            const allMek = await binn.getGroupMembers(groupId)
            for (let i = 0; i < allMek.length; i++) {
                if ((adminNumber, ownerNumber).includes(allMek[i].id)) {
                    console.log('Upss this is Admin group')
                } else {
                    await binn.removeParticipant(groupId, allMek[i].id)
                }
            }
            binn.reply(from, 'Success kick all member', id)
            break
